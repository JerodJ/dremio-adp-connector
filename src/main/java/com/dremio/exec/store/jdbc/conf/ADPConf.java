...
@SourceType(value = "ADPARP", label = "ADP",uiConfig = "adp-layout.json")
public class ADPConf extends AbstractArpConf<ADPConf> {
  private static final String ARP_FILENAME = "arp/implementation/adp-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.adp.ADPDriver";
